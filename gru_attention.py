...
def build_basic_model():
    ...
    decoder_outputs, decoder_states = Decoder_layer(decoder_embedding, encoder_states[0], constants = rnn_encoded) #encoder_states[0],rnn_encoded
...
epochs = 1
for i in range(0,5):
    basic_model_hist = basic_model.fit([encoder_input_data,decoder_input_data], decoder_target_data, batch_size=batch_size, epochs=epochs)
    # 保存模型
    basic_model.save_weights(new_model_path+'_epo_'+str(int(i)*1+epochs)+ '_weights' + '.h5')
'''
